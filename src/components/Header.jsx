...
const tags = ["Tools", "AWS Builders", "Start Build", "Build Supplies", "Tooling", "BlueHosting"]


const Header = () => {
    return (
        <header>
            <h1 className='text-lg font-[600] md:text-3xl my-5'>Best Website Builders in the US</h1>
            <div className='flex flex-wrap items-center gap-5 border-t-2 border-b-2 py-3 text-[13px] text-[#4B5665]'>
                <span>
                    <svg className='size-5 inline mx-1' viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className='md:ml-auto'>
                    <select className='bg-transparent'>
                        ...
                        <option>Bottom Relevent</option>
                    </select>
                </span>
            </div>
            <div className='flex flex-wrap gap-x-5 gap-y-2 my-5'>
                {tags.map((tag, index) => (
                    <span className='bg-white px-4 py-2 rounded-md hover:cursor-pointer' key={index}>{tag}</span>
                ))}
            </div>
        </header>
    )
