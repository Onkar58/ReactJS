...
const projectData = [
    {
        label: {
            text: "Best Choice",
            icon: <svg className='size-5 inline' viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        data: {
            ...
            highlight: "Receive the WixPro website builder suite, access to premium design templates, an extensive library of widgets and apps, and detailed step-by-step guides."
        },
        reviews: {
            rating: 9.8,
            remark: "Exceptional",
    ...
    },
    {
        ...
        data: {
            ...
            highlight: "Gain access to the SiteCraft design studio, featuring a robust selection of design elements, SEO optimization tools, and e-commerce integrations."
        },
        reviews: {
            rating: 9.5,
            remark: "Excellent",
